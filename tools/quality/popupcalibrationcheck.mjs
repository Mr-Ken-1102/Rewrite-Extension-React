...
assert.match(a11y, /\.rwa2-popup \.rwa2-action\s*\{\s*font-size:10\.5px !important/);
assert.match(base, /\.rwa2-brand-title\s*\{[\s\S]*font-size:14\.5px;[\s\S]*font-weight:740;[\s\S]*letter-spacing:-\.015em/);
