...
assert.match(css, /\.rwa-connection-hub \.rwa-fast-rewrite-global/);
...
assert.match(popupContext, /Direct OpenAI-compatible API uses streaming/);
assert.match(popupContext, /Sidecar uses a more compact rewrite system prompt/);
