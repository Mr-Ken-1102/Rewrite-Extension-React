...
assert.match(ui, /Reset positions/);
assert.match(ui, /Đặt lại/);
assert.match(ui, /config\.draftReplyLauncherPlacement !== 'remember' && !Object\.keys\(config\.draftReplyLauncherPositions \|\| \{\}\)\.length/);
assert.match(ui, /updateConfig\(\{ draftReplyLauncherPositions: \{\} \}\)/);
assert.match(ui, /Remembered Persona Reply positions reset/);
assert.match(ui, /Đã đặt lại vị trí Trả lời theo Persona/);
