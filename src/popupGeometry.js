...
export const POPUP_PERFORMANCE_STRIP_HEIGHT = 28;
export const POPUP_CONTEXT_SUMMARY_HEIGHT = 62;
export const POPUP_CONTEXT_WRAP_EXTRA = 29;
export const POPUP_CONTEXT_DETAIL_HEIGHT = 46;
export const POPUP_NARROW_CONTEXT_EXTRA = 34;
