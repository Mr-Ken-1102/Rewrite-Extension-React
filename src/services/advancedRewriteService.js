...
const LEDGER_INFERENCE_CONFIG_KEYS = Object.freeze([
  ...
  'directTemp', 'requestTimeoutMs', 'marinaraTimeoutMs', 'maxPromptChars', 'lengthEnabled', 'lengthPct',
  'conciseSysPrompt', 'fastRewrite', 'freeMode', 'contextDepth', 'injectChar', 'injectUser',
