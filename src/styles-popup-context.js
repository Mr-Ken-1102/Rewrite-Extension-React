...
.rwa2-context-adjust-row::before { content:""; grid-column:2; width:1px; height:22px; background:rgba(255,255,255,.10); justify-self:center; }
.rwa2-context-depth {
  grid-column:1;
  min-width:0;
  display:grid;
...
.rwa2-adjust-icon { width:17px; height:17px; display:inline-grid; place-items:center; color:var(--rwa2-brand); }
