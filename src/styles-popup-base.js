...
.rwa2-performance-slot {
  min-width: 0;
  display: grid;
  grid-template-columns: auto minmax(0, 1fr);
  align-items: center;
}
.rwa2-performance-slot:first-child {
...
.rwa2-performance-item {
  ...
  cursor: pointer;
  overflow: hidden;
  transition: background-color .10s ease, color .10s ease, opacity .10s ease;
}
...
.rwa2-performance-slot:first-child .rwa2-performance-on .rwa2-performance-key { color: var(--rwa2-positive); }
