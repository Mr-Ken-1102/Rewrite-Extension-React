...
@media (max-width:419px) {
  ...
  .rwa2-brand-title { font-size:14px; }
  .rwa2-version { padding-inline:7px; }
  .rwa2-toolbar-actions { gap:4px; }
  .rwa2-icon-button { width:26px; height:26px; }
  .rwa2-trim-button { width:26px; min-width:26px; height:26px; padding:0; }
  .rwa2-performance-item { gap:4px; padding-inline:3px; }
  .rwa2-performance-key { letter-spacing:.03em; }
  .rwa2-profile-icon { width:15px; flex-basis:15px; }
  .rwa2-popup .rwa2-profile-btn { gap:5px !important; padding-inline:6px !important; }
