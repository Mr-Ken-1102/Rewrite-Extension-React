...
export const SettingsModal = ({ onClose, openEditProfile, openAIArchitect }) => {
  ...
  const handleTabChange = (tab) => {
    if (bodyRef.current) {
      bodyRef.current.dataset.scrollTop = bodyRef.current.scrollTop; 
    }
    setActiveTab(tab);
  };

  useEffect(() => {
    if (bodyRef.current && bodyRef.current.dataset.scrollTop) {
      bodyRef.current.scrollTop = bodyRef.current.dataset.scrollTop; 
    }
  }, [activeTab]);
  ...
  return (
    <div className="rwa-ov" onMouseMove={handleGlowMouseMove}>
      <div className="rwa-win rwa-settings-win">
        ...
        {!showAbout && (
          <div className="rwa-tabs rwa-settings-tabs">
            <button 
        ...
        <div ref={bodyRef} className="rwa-body rwa-settings-body">
          {showAbout ? (
            ...
            <div className="rwa-about-container">
              <div className="rwa-prev rwa-about-box">
                <div className="rwa-about-header-zone">
                  <h3 className="rwa-about-title">🚀 REWRITE ASSISTANT V2</h3>
            ...
            /* ======================================================
               ...
               ====================================================== */
            <>
              {activeTab === 'profiles' && <TabProfiles openEditProfile={openEditProfile} />}
            ...
            {activeTab === 'profiles' && (
              <>
                <Button 
                  ...
                  onClick={() => openEditProfile(null, -1)} 
                >
                  + Add Style
                </Button>
                <Button 
