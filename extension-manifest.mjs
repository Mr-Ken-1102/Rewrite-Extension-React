...
export const EXTENSION_DESCRIPTION = 'Safe in-place AI rewriting for Marinara Engine v2.4.4–v2.4.6 Personal Extensions. v3 adds guarded message PATCHing, Marinara connection support, privacy-safe session undo, Unicode-safe persistence, bounded diffing, and hardened lifecycle/network handling.';
